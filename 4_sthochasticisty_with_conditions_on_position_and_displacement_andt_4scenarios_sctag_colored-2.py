# -*- coding: utf-8 -*-
"""4_sthochasticisty_with_conditions_on_position_and_displacement_andt_4scenarios-Sctag_colored.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YH7TdGR8ZDXeLz83moOeulMdlvhbUKxY

Dataset from: 
@authors: Matthias Blanc and Giovanni Dalmasso. https://doi.org/10.7554/eLife.78300
"""
 ...
 for z in Cells:
  if 'neuron' in z:
    ...
    if dice_result in [1]:
      ...
      Cells.append(['stemcell', x , y, time_steps,q])
      ...
      if side_choice == -1:
        ...
        y=np.random.choice(ygrid_creation)
        Cells.append(['neuron', x, y,time_steps])
        ...
        if side_choice == -1:
            ...
            if (['neuron', x , y] in Cells):
                    K=[cell for cell in Cells if ['neuron', x , y] in Cells]
                    Cells.remove(['neuron',[x],[y]],time_steps)
                    Cells.append(['neuron', x+1, y],time_steps)
            else:
                    Cells.append(['neuron', x, y,time_steps])
